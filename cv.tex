...
\includegraphics[scale=0.01]{img/swimming.png}\includegraphics[scale=0.03]{img/kayak.png}\includegraphics[scale=0.05]{img/tennis.png}\includegraphics[scale=0.05]{img/running.png}
\end{aside}
