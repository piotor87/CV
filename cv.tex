...
\includegraphics[scale=0.05]{img/tri.png}\includegraphics[scale=0.05]{img/kayak.png}\includegraphics[scale=0.05]{img/travel.png}\includegraphics[scale=0.01]{img/cooking.png}
\end{aside}
